...
"""
maybe it should comment to the tweet only 
include emojies
"""
...
# manipulates the image
    ...
    font = ImageFont.truetype("fonts/seguiemj.ttf",font_size,encoding = 'unic')
...
createImage('Caso eu venha a \U0001F911 falecer, gostaria de deixar registrado aqui tambm que tenho interesse em ser doador de e tecidos.','fagnernunes11','https://pbs.twimg.com/profile_images/1251218278191640576/UpID8lrn_400x400.jpg','images/image1.png')
